...
- after adding the alarm panel to your esphome devices in Home Assistant make sure to enable the "Allow the device to perform Home Assistant actions." setting. See picture below for instruction on how to do that
- If needed tweak the settings in the substitutions section to suit your needs

<img src="./Pictures/allow_actions.png"/>
